...
- 🍏 **Нативная интеграция с macOS**: поддержка frameless-окна со скрытой строкой заголовка (`hiddenInset`) и ad-hoc цифровой подписью `codesign`.
...
│   │   ├── keychain.py            # Интеграция с Keychain / Credential Manager
